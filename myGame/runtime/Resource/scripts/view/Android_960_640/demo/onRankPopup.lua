local onRankPopup=
{
	name="onRankPopup",type=0,typeName="View",time=0,x=0,y=0,width=960,height=600,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignCenter,
	{
		...
		{
			name="RadioButtonGroup",type=0,typeName="RadioButtonGroup",time=0,x=5,y=30,width=553,height=100,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,varname="RadioButtonGroup",
			{
		...
		{
			name="ListView",type=0,typeName="ListView",time=0,x=6,y=31,width=554,height=368,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,varname="ListView"
		},
		{
			name="ImageHead",type=1,typeName="Image",time=0,x=713,y=51,width=64,height=64,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,file="game/backgroud/bgMyrank.png",varname="ImageHead",
			{
