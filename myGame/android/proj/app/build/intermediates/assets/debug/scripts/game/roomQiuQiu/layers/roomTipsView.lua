...
--
local RoomTipsView = class(Node)

RoomTipsView.WIDTH = System.getScreenWidth() * 0.7 - 16
...
function RoomTipsView:ctor()
    ...
    -- self.clip_ = CCClippingNode:create():addTo(self)
    ...
    -- self.label_ = ui.newTTFLabel({size=24, color=ccc3(0x2b, 0x56, 0x86),
...
function RoomTipsView:playNext_()
    ...
    --         self.currentIndex_ = 1
    --     end
    --     local nextLabel = ui.newTTFLabel({size=24, color=ccc3(0x2b, 0x56, 0x86),
    --             text=TIPS[self.currentIndex_],
    --             dimensions=cc.size(RoomTipsView.WIDTH - 8, 72),
    --             align=ui.TEXT_ALIGN_CENTER})
    --         :pos(0, -72)
