...
function SendChipView:ctor(chips)
    ...
    self.label_ = ui.newTTFLabel({text = nk.updateFunctions.formatBigNumber(chips), size = 20, align = ui.TEXT_ALIGN_CENTER, color = ccc3(255, 204, 0)})
            :addTo(self)
